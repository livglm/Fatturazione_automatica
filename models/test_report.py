...
class ParticularReport(models.AbstractModel):
    _name = 'report.Fatturazione_automatica.test_report1'

    @api.multi
    def render_html(self, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('Fatturazione_automatica.test_report1')
        ...
        return report_obj.render('Fatturazione_automatica.test_report1', docargs)